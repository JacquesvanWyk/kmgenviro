...
$navigation = [
    ...
    ['label' => 'About KMG', 'route' => 'about', 'children' => [
        ['label' => 'Our Team', 'route' => 'team'],
        ['label' => 'Accreditations', 'route' => 'accreditations'],
    ]],
    ['label' => 'Services', 'route' => 'services.index'],
    ['label' => 'Sectors & Projects', 'route' => 'sectors.index', 'children' => [
        ['label' => 'Industry Sectors', 'route' => 'sectors.index'],
        ['label' => 'Our Projects', 'route' => 'projects.index'],
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="flex justify-between items-center h-10">
            ...
            <div class="flex items-center gap-4">
                <a href="https://wa.me/27119696184" target="_blank" class="flex items-center gap-2 hover:text-green-400 transition-colors">
                ...
                <a href="#" class="hover:text-green-400 transition-colors">Download Company Profile</a>
            </div>
        </div>
    </div>
</div>
